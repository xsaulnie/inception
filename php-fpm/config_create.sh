...
then
	...
	#wp config create --dbhost=$WORDPRESS_DB_HOST --dbname=$WORDPRESS_DB_NAME --dbuser=$WORDPRESS_DB_USER --dbpass=$WORDPRESS_ROOT_PASSWORD --config-file=/var/www/html/wp-config.php --path=/var/www/html --allow-root
